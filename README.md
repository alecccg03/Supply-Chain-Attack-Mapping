...
| **Defense Evasion** | [T1550.001](https://attack.mitre.org/techniques/T1550/001/) | OAuth applications, once authorized, maintain persistent access tokens that survive rotations and do not require the user's password. |
